...
export default function ObraDetalle() {
  ...
  // Si no tiene voz asignada (Director), preseleccionar DEMO
  useEffect(() => {
    if (!obra?.audios?.length) return
    if (audioSeleccionado) return

    if (!perfil?.voz) {
      // Sin cuerda asignada (Director u otro): preseleccionar DEMO
  ...
  // Audio a reproducir: selección manual > ninguno
